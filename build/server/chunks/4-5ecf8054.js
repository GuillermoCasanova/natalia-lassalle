...
async function load({ params, fetch }) {
  ...
  const page_request = `*[_type == 'page' && handle.current == 'contact'][0] {
        ...,
        page_layout[]-> {
            ...,
