...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-6jst4i_START -->${validate_component(MetaTags, "MetaTags").$$render(
    ...
    {},
    {}
  )}<!-- HEAD_svelte-6jst4i_END -->`, ""} <div class="subpage"><div class="subpage__inner"><div class="subpage__left-content" data-left-content><div class="subpage__content-body main-container svelte-xzzq7k">${data.content.page_layout ? `${each(data.content.page_layout, (section) => {
...
//# sourceMappingURL=_page.svelte-BmJ4zmUj.js.map
