import { c as create_ssr_component, p as add_attribute, q as each, t as escape, x as spread, y as escape_object, o as subscribe, v as validate_component, m as missing_component } from './exports-DiiVpNfQ.js';
...
const MetaTags = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.robotsProps === void 0 && $$bindings.robotsProps && robotsProps !== void 0) $$bindings.robotsProps(robotsProps);
...
const css = {
  ...
  map: '{"version":3,"file":"external-link.svelte","sources":["external-link.svelte"],"sourcesContent":["<script lang=\\"ts\\">export let portableText;\\n$: ({ value } = portableText);\\n$: newWindow = value.blank;\\n$: href = value.href;\\n<\/script>\\n\\n<a {href} rel=\\"external\\" target={newWindow ? \\"_blank\\" : null}>\\n  <slot />\\n  {#if newWindow}\\n    <span class=\\"external-link-icon\\">\\n      <svg>\\n        <use xlink:href=\\"#icon-external-link\\" />\\n      </svg>\\n    </span>\\n  {/if}\\n</a>\\n\\n<style>\\n.external-link-icon {\\n  width: 0.75rem;\\n  height: 0.75rem;\\n  display: inline-block;\\n  margin-right: var(--level1);\\n}\\n\\n.external-link-icon svg {\\n  width: 100%;\\n  height: 100%;\\n}\\n</style>\\n"],"names":[],"mappings":"AAkBA,iDAAoB,CAClB,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,OAAO,CACf,OAAO,CAAE,YAAY,CACrB,YAAY,CAAE,IAAI,QAAQ,CAC5B,CAEA,kCAAmB,CAAC,kBAAI,CACtB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IACV"}'
};
const External_link = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  newWindow = value.blank;
  href = value.href;
  return `<a${add_attribute("href", href, 0)} rel="external"${add_attribute("target", newWindow ? "_blank" : null, 0)}>${slots.default ? slots.default({}) : ``} ${newWindow ? `<span class="external-link-icon svelte-1fd6ajc" data-svelte-h="svelte-i1r7ct"><svg class="svelte-1fd6ajc"><use xlink:href="#icon-external-link"></use></svg></span>` : ``} </a>`;
});
...
const Rich_text = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `${text ? `${validate_component(PortableText, "PortableText").$$render($$result, { value: text, components }, {}, {})}` : ``}`;
});

export { MetaTags as M, Rich_text as R };
//# sourceMappingURL=rich-text-C-lTZTxO.js.map
