...
type RouteId = '/[lang=lang]/contact';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/[lang=lang]/contact/+page.server.js').load>>>>>>;
