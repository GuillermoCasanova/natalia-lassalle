...
type RouteId = '/[lang=lang]/current';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/[lang=lang]/current/+page.server.js').load>>>>>>;
