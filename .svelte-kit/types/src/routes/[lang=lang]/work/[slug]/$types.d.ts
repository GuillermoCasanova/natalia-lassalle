...
type RouteParams = { lang: MatcherParam<typeof import('../../../../../../../src/params/lang.js').match>; slug: string };
type RouteId = '/[lang=lang]/work/[slug]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/[lang=lang]/work/[slug]/+page.server.js').load>>>>>>;
